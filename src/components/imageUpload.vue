            ...
            <div class="room-file-upload-wrapper">
                <div v-if="!files.length" class="room-file-upload-example-container">
                    <div class="room-file-upload-example">
                        ...
                        <div class="room-file-notice-item room-file-notice-item-red">로고를 제외한 불필요한 정보(워터마크,상호,전화번호 등)가 있는 매물은 비공개처리됩니다</div>
...
export default {
    data() {
        ...
        methods: {
                    imageUpload() {
                        //input 태그에 파일에 접근하기위해서 ref 속성을 부여해서 접근 
                        // this.files = [...this.files, this.$refs.files.files];
                        //하나의 배열로 넣기
                        //여기서 this vue 인스턴스 files 배열 Data에 선언.
                        
                        let num = -1;
                        console.log(`files.length = ${this.$refs.files.files.length}`) 
